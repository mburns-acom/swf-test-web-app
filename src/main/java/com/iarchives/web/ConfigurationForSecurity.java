...
public class ConfigurationForSecurity {
	...
	protected static class ApplicationSecurity extends WebSecurityConfigurerAdapter {
		...
		/**
		 * Configure routes that should be ignored by the security
		 * implementation, making them publicly available.
		 */
		@Override
		...
		/**
		 * Configure routes requiring admin privileges to access. Declare all
		 * other routes as requiring an authenticated user. Override POST only
		 * handling of the logout root and redirect to login on successful
		 * logout.
		 */
		@Override
	...
	/**
	 * Configure a customised UserDetailsService to be used for authentication.
	 * The service implementation will be injected by Spring at runtime.
	 * 
	 * @author Mark Burns
	 *
	 */
	...
	protected static class AuthenticationSecurity extends
		...
		public void init(AuthenticationManagerBuilder auth) throws Exception {
			// Setup username / password authentication provider
	...
	protected static class ProcessAuthSuccess extends
